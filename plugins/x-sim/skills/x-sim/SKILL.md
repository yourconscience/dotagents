...
This packaged copy mirrors the canonical dotagents skill at `skills/x-sim/SKILL.md`.
...
```bash
go run ./skills/x-sim/tools/x-sim init
go run ./skills/x-sim/tools/x-sim source add-account @handle
go run ./skills/x-sim/tools/x-sim source add-search "agent evals"
go run ./skills/x-sim/tools/x-sim sync --since 6m --limit-per-source 200
go run ./skills/x-sim/tools/x-sim brief --topic "agent evals" --out /tmp/x-sim-brief.md
go run ./skills/x-sim/tools/x-sim eval-tweet --text "draft tweet" --topic "agent evals" --out /tmp/x-sim-report.md
go run ./skills/x-sim/tools/x-sim eval-handle --bio "..." --promotion "..." --out /tmp/x-sim-handle.md
```
